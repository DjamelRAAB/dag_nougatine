...
with dag:
    ...
    submit_t1 = BashOperator(
        task_id = "submit_t1",
        bash_command = "export HADOOP_CONF_DIR=/etc/hadoop/conf && spark-submit --master yarn --deploy-mode cluster hdfs://d271ee89-3c06-4d40-b9d6-d3c1d65feb57.priv.instances.scw.cloud:8020/user/iabd2_group6/app/load_data_into_hive.py",
    ) 
